...
def send_welcome(message):
    ...
    welcome_text = (
        ...
        "⚡ **Yangi Yangilanish:**\n"
        "🔥 Endi tizimimiz 3 xil tilda (UZ, RU, EN) ishlaydi, Ommaviy testlar va Flesh-kartochkalar to'liq ishga tushdi!, Bizda endi Premium bo`limi ham ishlamoqda. O`zingizga qulay Limitni tanlab to`lov qiling va to`lov chekini ushbu Botga yuboring!\n\n"
